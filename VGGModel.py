"""""
This script uses tensorflow pre-trained architecture model, VGG-16 
to solve for the problem of Multiclassification Alzheimer Identification
"""""
